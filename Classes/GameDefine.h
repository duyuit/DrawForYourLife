...
namespace Define {
	...
	static string _music_lv1_background_path = "Music/lv1_background.mp3";
	static string _music_roll_effect_path= "Music/roll_effect.wav";
	static string _music_eat_ring_efftect_path = "Music/eat_ring_effect.wav";
	static string _music_jump_effect_path = "Music/sonic_jump_effect.mp3";
	static string _music_combo_effect_path = "Music/combo_effect.mp3";
	static string _music_button_effect_path = "Music/select_button.mp3";
	static string _music_finish_level_path = "Music/finish_level_background.mp3";
