...
bool LevelMap::init()
{
	...
	//level map
	auto loading = Sprite::create("Level_map/level_map_snow.png");
	...
	auto button_board_cancel = Button::create("Level_map/cancel.png");
	...
	button_level_0->addTouchEventListener([this](Ref* sender, Widget::TouchEventType type) {
		...
		case ui::Widget::TouchEventType::ENDED:
		{
			setStar(0, 2);// pos 0 - 2 star
			board->setVisible(true);
			//auto myScene = GamePlayScense::createScene();
	...
	// Level 2 button
	auto button_level_2 = Button::create("Menu/level_btn_bluepurple_big.png");
	...
	button_level_bonus->addTouchEventListener([&](Ref* sender, Widget::TouchEventType type) {
		...
		case ui::Widget::TouchEventType::ENDED:
		{
			setStar(6, 3); // level bonus - 3 star
			board->setVisible(true);
		}
		break;
		default:
